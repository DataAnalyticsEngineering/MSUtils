...
def multi_vti_to_h5(
    vti_files, h5_file_path, grp_name="images", data_field=None, overwrite=False
):
    """
        ...
        for vti_file in vti_files:
            ...
            if dset_name in images_group:
                if overwrite:
                    ...
                    print(
                        f"Dataset {dset_name} already exists and overwrite=False. Skipping."
                    )
                    continue
            ...
            try:
                ...
                # Select data field
                field_name = (
                    data_field if data_field in data_dict else list(data_dict.keys())[0]
                )
