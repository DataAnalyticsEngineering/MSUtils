...
Textile.AssignDomain(CDomainPlanes(XYZ(0, 0, -0.2), XYZ(4 * s, 4 * s, 0.4)))
...
vtk2h5(
    vtk_files=["data/NonCrimpFabric.vtu"],
...
write_xdmf(
    h5_filepath="data/TexGen_NonCrimpFabric.h5",
    xdmf_filepath="data/TexGen_NonCrimpFabric.xdmf",
    microstructure_length=[4, 4, 0.6],
    time_series=False,
    verbose=True,
)
