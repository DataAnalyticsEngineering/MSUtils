...
Textile.AssignDomain(CDomainPlanes(XYZ(0.25, 0.0, -0.1), XYZ(2.25, 0.57735, 0.3)))
...
vtk2h5(
    vtk_files=["data/triaxialbraid.vtu"],
...
write_xdmf(
    h5_filepath="data/TexGen_triaxialbraid.h5",
    xdmf_filepath="data/TexGen_triaxialbraid.xdmf",
    microstructure_length=[2.25, 0.57735, 0.3],
    time_series=False,
    verbose=True,
)
