...
class PeriodicVoronoiImage(MicrostructureImage):
    def __init__(self, N = None, seeds = None, L=[1, 1, 1], h5_filename=None, dset_name=None):
        if h5_filename is not None and dset_name is not None:
            ...
            super().__init__(h5_filename=h5_filename, dset_name=dset_name, image=image, resolution=N, L=L)
